...
class ProductView(View):
    ...
    def get(self, request, pincode='208012'):
        ...
        except ValueError: return HttpResponse("<h1>content not found</h1>")
        except: return HttpResponse("<h1>content not found</h1>")
        else: return JsonResponse(productSerializedData.data, safe=False)
